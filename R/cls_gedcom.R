...
class_gedcom_source <- S7::new_class(
  ...
  properties = list(
    ...
    data_pubdate = S7::new_property(S7::new_union(NULL, 
                                                  class_date_exact, 
                                                  S7::class_character)),
    data_pubtime = S7::new_property(S7::new_union(NULL, 
                                                  class_time, 
                                                  S7::class_character)),
...
class_gedcomS7 <- S7::new_class(
  ...
  properties = list(
    ...
    creation_date = S7::new_property(S7::new_union(NULL, 
                                                   class_date_exact, 
                                                   S7::class_character)),
    creation_time = S7::new_property(S7::new_union(NULL, 
                                                   class_time, 
                                                   S7::class_character)),
