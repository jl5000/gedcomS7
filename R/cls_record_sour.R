    ...
    GEDCOM = S7::new_property(
      ...
      getter = function(self){
        c(
          ...
          obj_to_ged(self@call_numbers, "CALN") |> level_up(1)
        )
      })
  )
)
    ...
    GEDCOM = S7::new_property(
      ...
      getter = function(self){
        c(
          ...
          obj_to_ged(self@territory, "PLAC") |> level_up(1)
        )
      })
  )
)
    ...
    GEDCOM = S7::new_property(
      ...
      getter = function(self){
        c(
          ...
          obj_to_ged(self@facts_recorded, "EVEN") |> level_up(2),
          ...
          obj_to_ged(self@source_text, "TEXT") |> level_up(1) |> 
            gsub(pattern = "(^\\d) TRAN ", replacement = "\\1 TEXT "),
          obj_to_ged(self@repo_citations, "REPO") |> level_up(1),
