...
class_citation <- S7::new_class(
  ...
  properties = list(
    ...
    fact_phrase = S7::class_character,
  ...
  validator = function(self){
    c(
      ...
      chk_input_size(self@fact_type, "@fact_type", 0, 1),
      chk_input_size(self@fact_phrase, "@fact_phrase", 0, 1, 1),
      ...
      chk_input_parents(self@fact_phrase, "@fact_phrase", 
