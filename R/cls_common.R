...
class_media_link <- S7::new_class(
  ...
  validator = function(self) {
    c(
      ...
      chk_whole_number(input@top, "@top"),
      chk_whole_number(input@left, "@left"),
      chk_whole_number(input@height, "@height"),
      chk_whole_number(input@width, "@width"),
...
class_citation <- S7::new_class(
      ...
      getter = function(self){
        c(
          ...
          rep("1 DATA", length(self@date) + 
                length(self@date_phrase) + 
                length(self@source_text) > 0),
          sprintf("2 DATE %s", datetime_to_val(self@date)),
          sprintf("3 TIME %s", datetime_to_val(self@time)),
          sprintf("3 PHRASE %s", self@date_phrase),
  ...
  validator = function(self){
    c(
      ...
      chk_whole_number(input@certainty, "@certainty"),
