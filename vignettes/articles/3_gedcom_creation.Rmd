...
* Those that allow the user to control whether creation/change dates are added to records as they are pushed to the GEDCOM object (`@update_change_dates` and `@add_creation_dates`);
