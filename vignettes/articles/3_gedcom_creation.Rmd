...
The easiest way to create a GEDCOM object is to import an existing GEDCOM file. When you use `summary()` on a GEDCOM object to the console it provides a brief summary of the file. The example below imports the smallest legal GEDCOM file:
