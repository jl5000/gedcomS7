...
- inc_sibs:
  ...
  Whether to also include all siblings of ancestors (siblings of this
  individual will only be included if the individual is included).

- inc_fam:

  Whether to also include all Family records where this individual is a
  child (and all ancestors' Family records).
