...
test_that("Function get_families_as_partner() @ L63", {
  ...
  expect_equal(get_fam_as_partner(sample555, "@I1@"), c("@F1@", "@F2@"))
  expect_equal(get_fam_as_partner(sample555, "@I2@"), "@F1@")
  expect_equal(get_fam_as_partner(sample555, "@I3@"), character())

  expect_equal(get_fam_as_child(sample555, "@I3@"), c("@F1@", "@F2@"))
  expect_equal(get_fam_as_child(sample555, "@I1@"), character())
  ...
  expect_equal(get_fam_partners(sample555, "@F1@"), c("@I1@", "@I2@"))

  expect_equal(get_fam_children(sample555, "@F1@"), "@I3@")
  expect_equal(get_fam_children(sample555, "@F2@"), "@I3@")
  expect_equal(get_fam_children(sample555, "@F2@", birth_only = TRUE), character())
