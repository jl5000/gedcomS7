...
test_that("Function reg_date_period() @ L228", {
...
test_that("Function reg_date_range() @ L263", {
...
test_that("Function reg_date_approximated() @ L297", {
...
test_that("Function reg_date_value() @ L339", {
