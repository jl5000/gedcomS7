...
test_that("Function reg_date_period() @ L209", {
...
test_that("Function reg_date_range() @ L240", {
...
test_that("Function reg_date_approximated() @ L271", {
...
test_that("Function reg_date_value() @ L310", {
