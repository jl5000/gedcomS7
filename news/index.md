...
- Names and values of `@ext_ids` are now concatenated directly when
  constructing URIs - trailing slashes must be explicit
- Record and Fact objects no longer have `@GEDCOM_IDENTIFIERS` and
