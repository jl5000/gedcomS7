...
The package does not currently support the following:

* Extension tags
* Mediums of SOURCE_REPOSITORY_CITATION call numbers (SOUR.REPO.CALN.MEDI)

If you import a file with these features, the package may behave unpredictably.
